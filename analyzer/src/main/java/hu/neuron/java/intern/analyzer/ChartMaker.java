...
public class ChartMaker extends ApplicationFrame {
	...
	public ChartMaker(List implementsList, List methodsList, List timesList, String title) {

		super(title);

		final CategoryDataset dataset1 = createDataset1(implementsList, methodsList, timesList);
		// create the chart...
	...
	public CategoryDataset createDataset1(List listImplements, List methodsList, List timesList) {
		...
		for (Object obj : listImplements) {
			...
			for (int i = 0; i < methodsList.size(); i++) {
				...
				String s = timesList.get(timeindex).toString();
